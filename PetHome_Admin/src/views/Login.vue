<template>
  <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-position="left" label-width="0px" class="demo-ruleForm login-container">
    ...
    <el-form-item style="width:100%;">
      <el-button type="success" style="width:100%;" @click.native.prevent="toShopRegister" >商家入驻</el-button>
      <!--<el-button @click.native.prevent="handleReset2">重置</el-button>-->
    </el-form-item>
  </el-form>
</template>
      ...
      handleSubmit2(ev) {
        ...
        this.$refs.ruleForm2.validate((valid) => {
          if (valid) {
            ...
            //NProgress.start();
            var loginParams = { username: _this.ruleForm2.account, password: _this.ruleForm2.checkPass,type:2 };
            console.debug(loginParams)
            _this.$http.post("/login/login",loginParams).then(res => {
