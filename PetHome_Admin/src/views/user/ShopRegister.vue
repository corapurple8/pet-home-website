<template>
    <div>
        ...
        <el-form :model="shop" ref="shopForm" :rules="formRules" label-position="left" label-width="100px" class="demo-ruleForm login-container">
            ...
            <el-form-item prop="tel" label="店铺号码">
                <el-input type="text" v-model="shop.tel" auto-complete="off" placeholder="请输入店铺号码！"></el-input>
            </el-form-item>
            <!--使用百度地图-->
            ...
            <el-form-item prop="logo" label="店铺Logo">
                <!--文件上传的标签  action上传的地址 preview预览事件 remove删除事件 success成功事件 还有name 默认是file 所以后端只能写file接收-->
                <el-upload
                        class="upload-demo"
